...
const Users = () => (
  <div>
    <h2>Software anecdotes app</h2>
    <ul>
      <li>Jeremias Korhonen</li>
      <li>Pekka Puu</li>
    </ul>
  </div>
)
...
const App = () => {
  ...
  const addNew = (anecdote) => {
    ...
    NotificationManager.success('Successfully created anecdote', anecdote.content, 10000);
